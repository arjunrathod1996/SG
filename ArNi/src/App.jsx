...
// import BusinessPageTry from './components/userspage/BusinessPageTry';
...
//     navigate('/login');   // Redirect to login page without reloading
//   };
...
//                                   {/* <h1 className="my-4">Business Management</h1> */}
...
// <Route 
//             path="/dashboard/businessTry" 
//             element={<PrivateRoute 
//                       element={<BusinessPageTry user={user} />} 
//                       allowedRoles={[
//                         "ROLE_ADMIN", 
//                         "ROLE_MERCHANT", 
//                         "ROLE_MERCHANT_STAFF", 
